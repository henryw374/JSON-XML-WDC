...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js"), __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "./node_modules/@babel/runtime/helpers/defineProperty.js"), __webpack_require__(/*! @babel/runtime/helpers/typeof */ "./node_modules/@babel/runtime/helpers/typeof.js"), __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/asyncToGenerator.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : this, function (_regenerator, _defineProperty2, _typeof2, _asyncToGenerator2) {
  "use strict";
  ...
  var myConnector = tableau.makeConnector(); // Create the schemas for each table
    ...
    _retrieveJsonData({
      ...
      var _loop = function _loop(table) {
        ...
        function findFriendlyName(f, tryNum) {
          var names = f.split('.');
          var alias = names.slice(names.length - tryNum, names.length).join(' ').replace(/_/g, ' ');
  ...
  tableau.registerConnector(myConnector); // Gets data from URL or string. Inputs are all strings. Always returns JSON data, even if XML input.

  function _retrieveJsonData(_x, _x2) {
    return _retrieveJsonData2.apply(this, arguments);
  } // Turns tabular data into json for Tableau input


  function _retrieveJsonData2() {
    _retrieveJsonData2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(_ref, retrieveDataCallback) {
      var dataString, dataUrl, method, token, rawData, result, successCallback;
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              dataString = _ref.dataString, dataUrl = _ref.dataUrl, method = _ref.method, token = _ref.token;
              rawData = dataString;
    ...
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        ...
        for (var _field2 in fields) {
          var header = headers[fields[_field2]];
          var value = line[_field2];

          if (value === '' || value === '""' || value === 'null' || value === null) {
            obj[fields[_field2]] = null;
            header["null"] = header["null"] ? header["null"] + 1 : 1;
          } else if (value === 'true' || value === true) {
            obj[fields[_field2]] = true;
            header.bool = header.bool ? header.bool + 1 : 1;
          } else if (value === 'false' || value === false) {
            obj[fields[_field2]] = false;
            header.bool = header.bool ? header.bool + 1 : 1;
          } else if ((0, _typeof2["default"])(value) === 'object') {
            obj[fields[_field2]] = value.toISOString();
            header.string = header.string ? header.string + 1 : 1;
          } else if (!isNaN(value)) {
            obj[fields[_field2]] = value;
  ...
  function _jsToTable(data, fields) {
    ...
    var json2csvParser = new json2csv.Parser({
      fields: fields,
      transforms: [json2csv.transforms.unwind({
        paths: paths
      })]
    });
  ...
  function _pathsToTree(paths) {
    ...
    function makeTree(path, level) {
      ...
      if (level === 0) {
        ...
        var _iterator5 = _createForOfIteratorHelper(levels.slice(1, level + 1)),
            _step5;
  ...
  function _addTable() {
    ...
    tableID++;
    var tableTemplate = "\n    <div class=\"table\" data-tableid=\"".concat(tableID, "\">\n      <p class=\"label\">Table Name</p>\n      <div class=\"row\">\n        <input data-tableid=\"").concat(tableID, "\" type=\"text\" placeholder=\"My Data (").concat(tableID + 1, ")\"/>\n        <button class=\"delete\" data-tableid=\"").concat(tableID, "\" onclick=\"_deleteTable(this)\">Delete</button>\n      </div>\n      <div class=\"selections\">\n        <span><a onclick=\"_selectAll(this)\" data-tableid=\"").concat(tableID, "\">Select All</a></span>\n        <span><a onclick=\"_clearAll(this)\" data-tableid=\"").concat(tableID, "\">Clear All</a></span>\n      </div>\n      <div class=\"fields\" data-tableid=\"").concat(tableID, "\">No data fields found</div>\n    </div>\n  ");
  ...
  function _askForFields(_x3) {
    return _askForFields2.apply(this, arguments);
  } // Checks if JSON is parseable


  function _askForFields2() {
    _askForFields2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(tableID) {
      var conData, dataString, dataUrl, method, token, div, fieldsTree, output, displayFields;
      return _regenerator["default"].wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              displayFields = function _displayFields(fields, spacing, parent) {
                for (var field in fields) {
                  var showCheck = Object.keys(fields[field]).length === 0;
                  output += "<div class='field' onclick='".concat(showCheck ? '_toggleCheck(this)' : '_toggleChildCheck(this)', "' data-checked='false' style=\"padding-left:").concat(spacing, "px;\" data-tableid='").concat(tableID, "' data-visible='").concat(showCheck, "' data-field='").concat((parent === '' ? '' : parent + '.') + field, "'>\n        ").concat(showCheck ? '<div class="check"></div>' : '<div class="check nested"></div>', "\n        <div class=\"fieldText\" >\n          ").concat(field, "\n        </div>\n      </div>");
              ...
              conData = JSON.parse(tableau.connectionData);
              dataString = conData.dataString;
              dataUrl = conData.dataUrl;
              method = conData.method;
              token = tableau.password;
              div = $('.fields[data-tableid=' + tableID + ']');
              _context2.next = 9;
              return _retrieveJsonData({
                dataString: dataString,
                dataUrl: dataUrl,
                method: method,
                token: token
  ...
  function _submitDataToTableau() {
    var tables = {}; // Make sure no duplicate table names

    $('.table').each(function () {
      var tableName = ($(this).find('input[data-tableid]').val() || 'My Data').trim();
      var tableID = $(this).find('input[data-tableid]').data('tableid');
      ...
      function createUniqueID(tableTableauID, tryNum) {
        ...
        tables.hasOwnProperty(tableTableauID + tryText) ? createUniqueID(tableTableauID, tryNum + 1) : tables[tableTableauID + tryText] = {
          id: tableID,
    ...
    for (var _table in tables) {
      tables[_table].fields.length === 0 ? delete tables[_table] : fieldCount++;
    }

    if (fieldCount > 0) {
      var conData = JSON.parse(tableau.connectionData);
      conData = _objectSpread(_objectSpread({}, conData), {}, {
        tables: tables
      });
  ...
  function _toggleChildCheck(e) {
    ...
    var children = $('#tables').find("[data-tableID='".concat(parentTableID, "'][data-field^='").concat(parentField, "'][data-field!='").concat(parentField, "']"));
  ...
  $(document).on('dragenter', cancel).on('drop', cancel).on('dragover', function (e) {
    cancel(e);
  ...
  $('#dragdrop').on('dragenter', cancel).on('dragover', function (e) {
    cancel(e);
...
/***/ 0:
/*!***********************************************!*\
  !*** multi babel-polyfill ./public/script.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! ./public/script.js */"./public/script.js");
